export const PlainListData = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco labo ris nisi ut aliquip ex ea commodo consequat.",
  },
  {
    name: "Garry Sobars",
...
export const data = [
  ...
  },
  {
    ...
    image: "https://via.placeholder.com/150x150",
    description:
      "Many desktop publishing packages and web page editors now use Lorem Ipsum as their CRM model text, and a search for 'lorem ipsum' ",
  },
  {
    name: "Domnic Brown",
    buttonList: [{ name: "html" }, { name: "css" }, { name: "java" }],
